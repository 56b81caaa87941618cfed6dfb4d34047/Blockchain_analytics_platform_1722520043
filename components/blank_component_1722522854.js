        ...
        <div>
            ...
            <section id="blank-section" class="bg-gradient-to-br from-pink-400 via-purple-500 to-indigo-600 flex-1 min-h-screen">
                ...
                <div id="blank-container" class="max-w-screen-xl px-8 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                    <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white border-opacity-20">
                        <h2 class="text-4xl font-extrabold text-white mb-6 font-sans">Welcome to Our Cosmic World</h2>
                        <p class="text-lg text-pink-100 mb-8 font-light">Explore the vibrant universe of possibilities with us.</p>
                        <button class="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-bold py-3 px-6 rounded-full shadow-lg transition duration-300 transform hover:scale-105 backdrop-filter backdrop-blur-sm bg-opacity-70">
                            Start Your Journey
                        </button>
                        <button class="bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 text-white font-bold py-3 px-6 rounded-full shadow-lg transition duration-300 transform hover:scale-105 ml-4 backdrop-filter backdrop-blur-sm bg-opacity-70">
                            Submit
                        </button>
                    </div>
                </div>
